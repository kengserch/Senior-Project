...
// }
 ...
 const [time1, setTime1] = useState(0);
  ...
  const selectNumber1 = numberSelected => {
    ...
    //deadline.setMinutes(deadline.getMinutes() + time);
    deadline.setMinutes(deadline.getMinutes() + time1);
    return deadline ;
 ...
 // let [hourtime , setHourtime] = useState(0);
  ...
  const setCustomTime = () =>{
    ...
    setTime3(time3)
    deadline.setSeconds(deadline.getSeconds() + time3);
    return deadline ;
